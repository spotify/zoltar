...
final class NativeLibrary {
  ...
  public static void load() {
    ...
    final InputStream jniResource =
        org.tensorflow.NativeLibrary.class.getClassLoader().getResourceAsStream(jniResourceName);
    ...
    final InputStream frameworkResource =
        org.tensorflow.NativeLibrary.class.getClassLoader().getResourceAsStream(frameworkResourceName);
  ...
  private static boolean resourceExists(String baseName) {
    return org.tensorflow.NativeLibrary.class.getClassLoader().getResource(makeResourceName(baseName)) != null;
  }
  ...
  private static String getMajorVersionNumber() {
    String version = org.tensorflow.NativeLibrary.class.getPackage().getImplementationVersion();
